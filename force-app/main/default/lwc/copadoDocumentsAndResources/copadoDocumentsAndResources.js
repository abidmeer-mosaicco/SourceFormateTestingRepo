...
export default class CopadoDocumentsAndResources extends LightningElement {
    @api sectionValue = 'Copado Docs and Resources';  // exact picklist label
    @api pageTitle = 'Copado Docs and Resources';
