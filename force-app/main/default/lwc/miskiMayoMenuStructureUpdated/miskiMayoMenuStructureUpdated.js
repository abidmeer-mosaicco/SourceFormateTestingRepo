...
import MM_POLITICA_DE_PROTECCION_DE_DATOS_PERSONALES from '@salesforce/label/c.MM_POLITICA_DE_PROTECCION_DE_DATOS_PERSONALES';
import MM_POLITICA_DE_PROTECCION_DE_DATOS_PERSONALES_MENU_LABEL from '@salesforce/label/c.MM_POLITICA_DE_PROTECCION_DE_DATOS_PERSONALES_MENU_LABEL';

const LABELS = {
  MM_BASEURL,
  MM_CONOCENOS_NOSOTROS, MM_CONOCENOS_ACCIONISTAS, MM_CONOCENOS_LIDERES, MM_CONOCENOS_PREMIOS,
  MM_PROCESO_PRODUCTIVO, MM_HACEMOS_MINERIA_VERDE, MM_NUESTRO_PRODUCTO,
  MM_GESTION_SOCIAL, MM_COMPROMISOS_CONTRACTUALES, MM_PROGRAMAS_SOCIALES, MM_PROVEDORES_CONTRATISTAS,
  MM_SEGURIDAD, MM_SISTEMA_INTEGRAL_DE_GESTION, MM_9REGLAS_PARA_SALVAGUARDAR_VIDAS, MM_HERRAMIENTAS_DE_GESTION,
  MM_SALUD, MM_GESTION_AMBIENTAL, MM_INSTRUMENTOS_DE_GESTION_AMBIENTAL_APROBADOS, MM_PROGRAMA_DE_MONITOREO_AMBIENTAL,
  MM_PLAN_DE_CIERRE_DE_MINA, MM_POLITICA_SIG_Y_POLITICA_SSMA, MM_ETICA_Y_CUMPLIMIENTO, MM_PREVENCION_DE_LA_DISCRIMINACION,
  MM_CONDUCTA_Y_ETICA_DEL_PROVEEDOR, MM_DIVERSIDAD_E_INCLUSION, MM_NOTAS_DE_PRENSA, MM_RESENAS_INSTITUCIONALES,
  MM_BOLETINES, MM_OTRAS_PUBLICACIONES, MM_REGISTRA_TU_CONSULTA, MM_PREGUNTAS_FREQUENTES, MM_TRABAJA_CON_NOSOTROS,
  MM_PROVEEDORES, MM_INGRESO_A_PUERTO, MM_EXTERNAL_ADRYAN, MM_EXTERNAL_WORKDAY, MM_EXTERNAL_WORKPLACE,
  MM_EXTERNAL_CONSULTAS, MM_PROCEDIMIENTO_DE_QEJAS_Y_RECLAMOS, MM_DANOS_A_CONOCER_TU_EMPRESA,
  MM_CONOCENOS_MENU_LABEL, MM_MINERIA_VERDE_MENU_LABEL, MM_SOSTENIBILIDAD_MENU_LABEL, MM_SEGURIDAD_MENU_LABEL,
  MM_SALUD_MENU_LABEL, MM_GESTION_AMBIENTAL_MENU_LABEL, MM_POLITICAS_CORPORATIVAS_MENU_LABEL,
  MM_NOTICIAS_Y_PUBLICACIONES_MENU_LABEL, MM_CONTACTENOS_MENU_LABEL, MM_NOSOTROS_MENU_LABEL,
  MM_NUESTROS_ACCIONISTAS_MENU_LABEL, MM_NUESTROS_LIDERES_MENU_LABEL, MM_PREMIOS_Y_RECONOCIMIENTOS_MENU_LABEL,
  MM_PROCESO_PRODUCTIVO_MENU_LABEL, MM_HACEMOS_MINERIA_VERDE_MENU_LABEL, MM_NUESTRO_PRODUCTO_MENU_LABEL,
  MM_GESTION_SOCIAL_MENU_LABEL, MM_COMPROMISOS_CONTRACTUALES_MENU_LABEL, MM_PROGRAMAS_SOCIALES_MENU_LABEL,
  MM_PROVEEDORES_Y_CONTRATISTAS_LOCALES_MENU_LABEL, MM_SISTEMA_INTEGRAL_DE_GESTION_MENU_LABEL,
  MM_9_REGLAS_PARA_SALVAGUARDAR_VIDAS_MENU_LABEL, MM_HERRAMIENTAS_DE_GESTION_MENU_LABEL,
  MM_INSTRUMENTOS_DE_GESTION_AMBIENTAL_APROBADOS_MENU_LABEL, MM_PROGRAMA_DE_MONITOREO_AMBIENTAL_MENU_LABEL,
  MM_PLAN_DE_CIERRE_DE_MINA_MENU_LABEL, MM_POLITICA_SIG_Y_POLITICA_SSMA_MENU_LABEL, MM_ETICA_Y_CUMPLIMIENTO_MENU_LABEL,
  MM_PREVENCION_DE_LA_DISCRIMINACION_ACOSO_Y_LAS_REPRESALIAS_MENU_LABEL, MM_CONDUCTA_Y_ETICA_DEL_PROVEEDOR_MENU_LABEL,
  MM_DIVERSIDAD_E_INCLUSION_MENU_LABEL, MM_NOTAS_DE_PRENSA_MENU_LABEL, MM_RESENAS_INSTITUCIONALES_MENU_LABEL,
  MM_BOLETINES_MENU_LABEL, MM_OTRAS_PUBLICACIONES_MENU_LABEL, MM_CONSULTAS_MENU_LABEL,
  MM_POLITICA_DE_PROTECCION_DE_DATOS_PERSONALES, MM_POLITICA_DE_PROTECCION_DE_DATOS_PERSONALES_MENU_LABEL 
};

export default class MiskiMayoMenuStructureUpdated extends NavigationMixin(LightningElement) {
  @track isOpen = false;

  logoSrc = ICON + '/miskiMayoIconFinal.png';

  toggleMenu() { this.isOpen = !this.isOpen; }

  get menuClass() { return this.isOpen ? 'menu open' : 'menu'; }
    ...
    return [
      ...
      },
      {
        ...
        subItems: [
          ...
          { name: LABELS.MM_SALUD_MENU_LABEL, labelName: 'MM_SALUD' },
          {
      ...
      },
      {
        ...
        subItems: [
          { name: LABELS.MM_POLITICA_DE_PROTECCION_DE_DATOS_PERSONALES_MENU_LABEL, labelName: 'MM_POLITICA_DE_PROTECCION_DE_DATOS_PERSONALES' },
