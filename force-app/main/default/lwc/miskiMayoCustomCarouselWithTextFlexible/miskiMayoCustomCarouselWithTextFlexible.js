...
export default class MiskiMayoCustomCarouselWithTextFlexible extends LightningElement {
    slides = [];
    slides2 = [];
    slideIndex = 1;
    timer;
    ...
    get textHeadingStyle() {
        if(this.textDescription == null || this.textDescription == undefined || this.textDescription == '')
        {
            return `display:none`;
        } else
        {
