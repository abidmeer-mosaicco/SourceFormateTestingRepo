...
export default class DocumentDeployingChanges extends LightningElement {
    @api sectionValue = 'Deploying Changes';  // exact picklist label
    @api pageTitle = 'Deploying Changess';
